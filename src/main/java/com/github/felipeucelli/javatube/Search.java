...
public class Search {
    ...
    public static class Filter {
        ...
        public Filter type(Type type) { this.TYPE = type.label; return this; }
        public Filter uploadData(UploadData uploadData) { this.UPLOAD_DATA = uploadData.label; return this; }
        public Filter duration(Duration duration) { this.DURATION = duration.label; return this; }
        public Filter feature(Feature feature) { this.FEATURE.add(feature.label); return this; }
        public Filter feature(List<Feature> feature) {
            for (Feature f : feature){
                this.FEATURE.add(f.label);
            }
            return this;
        }
        public Filter sortBy(SortBy sortBy) { this.SORTBY = sortBy.label; return this; }
