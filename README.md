...
An example run command could look like this: `java -jar -Dspring.profiles.active=local media-share-app-<Version>.jar`.
...
An example run command could look like this: `java -jar -Dspring.profiles.active=remote media-share-app-<Version>.jar`.
...
The resulting jar will be placed in the build/libs/ directory.